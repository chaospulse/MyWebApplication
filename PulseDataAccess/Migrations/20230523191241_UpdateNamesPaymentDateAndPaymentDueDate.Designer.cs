...
namespace PulseDataAccess.Migrations
{
    ...
    [Migration("20230523191241_UpdateNamesPaymentDateAndPaymentDueDate")]
    partial class UpdateNamesPaymentDateAndPaymentDueDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PulseModels.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PulseModels.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PulseModels.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PulseModels.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PulseModels.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("PulseModels.OrderDetails", b =>
                {
                    b.HasOne("PulseModels.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PulseModels.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("PulseModels.OrderHeader", b =>
                {
                    b.HasOne("PulseModels.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PulseModels.ApplicationUser", b =>
                {
                    b.HasOne("PulseModels.Company", "Company")
                        .WithMany()
